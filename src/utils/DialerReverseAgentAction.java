// Source File Name: DialerReverseAgentAction.java
package utils;
...
public class DialerReverseAgentAction {

    private static final Logger logger = Logger.getLogger(DialerReverseAgentAction.class);
    protected SQLiteDatabase database;
    private final String context;
    private final String queue;
    private final ManagerConnection connection;

    public DialerReverseAgentAction(ManagerConnection connection) {
