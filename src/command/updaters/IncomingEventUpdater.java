// Source File Name:   IncomingEventUpdater.java
...
public class IncomingEventUpdater extends AbstractEventUpdater
{

    public IncomingEventUpdater(DialEvent event)
    {
        this.event = event;
    }

    public IncomingEventUpdater(DialBeginEvent event)
    {
        this.event = event;
    }
    ...
    {
        List eventParams = new ArrayList<>();
        if("Begin".equals(event.getSubEvent()) && event.getUniqueId() != null && event.getDestUniqueId() != null)
        {
            ...
            if(callIds.size() > 0)
            {
                ...
                eventParams.add(new BasicNameValuePair("phone", event.getCallerIdNum()));
                ...
                eventParams.add(new BasicNameValuePair("dialerCallID", callId));
