// Source file name: DeleteCampaignServlet.java
...
@WebServlet(name="DeleteCampaingServlet", urlPatterns={"/delcampaign"})
public class DeleteCampaignServlet extends HttpServlet {
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            DeleteCampaignAction action = new DeleteCampaignAction(request);
